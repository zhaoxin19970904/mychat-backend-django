...
from api.views import test, chatmessage,home ,article_detail ,search_articles,test_mysql_connection,login,google,admins,clients,adminssearch,createUser
from api.views import get_clients,get_students,get_teachers,CreateCourse,get_courses,get_course,get_user,get_personcourse,person_remove
from api.views import chatdetails,getchat,delete_student,update_student,deletechat
from api.views import delete_course,update_course,add_person_to_course,person_pay,course_students
urlpatterns = [
    ...
    path('chatmessage',chatmessage,name='chatmessage'),
    path('getchat/<int:cid>',getchat,name='getchat'),
    path('chatdetails/<int:id>',chatdetails,name='chatdetails'),
    path('deletechat/<int:id>',deletechat,name='deletechat'),
    path('users/admins', admins , name='admin1'),
    path('users/clients', clients , name='admin1'),
    ...
    path('users/clients', get_clients, name='get_clients'),
    ...
    # path('users/clients/<int:id>', get_user, name='get_user'),
